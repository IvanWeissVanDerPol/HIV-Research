...
DRUG_RESISTANCE = {
    ...
    'M184V': {'wt': 'M', 'mut': 'V', 'drugs': ['3TC', 'FTC'], 'resistance': 'high', 'fitness': 'moderate_decrease', 'class': 'NRTI'},
    'K65R': {'wt': 'K', 'mut': 'R', 'drugs': ['TDF', 'ABC'], 'resistance': 'moderate', 'fitness': 'moderate_decrease', 'class': 'NRTI'},
    'K70R': {'wt': 'K', 'mut': 'R', 'drugs': ['AZT', 'D4T'], 'resistance': 'moderate', 'fitness': 'moderate_decrease', 'class': 'NRTI'},
    'T215Y': {'wt': 'T', 'mut': 'Y', 'drugs': ['AZT', 'D4T'], 'resistance': 'high', 'fitness': 'minimal', 'class': 'NRTI'},
    'L74V': {'wt': 'L', 'mut': 'V', 'drugs': ['ABC', 'DDI'], 'resistance': 'high', 'fitness': 'moderate_decrease', 'class': 'NRTI'},
    # NNRTIs (Non-Nucleoside RT Inhibitors)
    'K103N': {'wt': 'K', 'mut': 'N', 'drugs': ['EFV', 'NVP'], 'resistance': 'high', 'fitness': 'minimal', 'class': 'NNRTI'},
    'Y181C': {'wt': 'Y', 'mut': 'C', 'drugs': ['NVP', 'EFV'], 'resistance': 'high', 'fitness': 'minimal', 'class': 'NNRTI'},
    'G190A': {'wt': 'G', 'mut': 'A', 'drugs': ['NVP', 'EFV'], 'resistance': 'high', 'fitness': 'minimal', 'class': 'NNRTI'},
    'K101E': {'wt': 'K', 'mut': 'E', 'drugs': ['NVP', 'EFV'], 'resistance': 'moderate', 'fitness': 'minimal', 'class': 'NNRTI'},
    # PIs (Protease Inhibitors)
    'M46I': {'wt': 'M', 'mut': 'I', 'drugs': ['IDV', 'NFV'], 'resistance': 'moderate', 'fitness': 'minimal', 'class': 'PI'},
    'I84V': {'wt': 'I', 'mut': 'V', 'drugs': ['DRV', 'ATV'], 'resistance': 'high', 'fitness': 'moderate_decrease', 'class': 'PI'},
    'V82A': {'wt': 'V', 'mut': 'A', 'drugs': ['IDV', 'RTV'], 'resistance': 'high', 'fitness': 'minimal', 'class': 'PI'},
    'L90M': {'wt': 'L', 'mut': 'M', 'drugs': ['SQV', 'NFV'], 'resistance': 'moderate', 'fitness': 'minimal', 'class': 'PI'},
    # INSTIs (Integrase Strand Transfer Inhibitors)
    'N155H': {'wt': 'N', 'mut': 'H', 'drugs': ['RAL', 'EVG'], 'resistance': 'high', 'fitness': 'moderate_decrease', 'class': 'INSTI'},
    'Q148H': {'wt': 'Q', 'mut': 'H', 'drugs': ['RAL', 'EVG', 'DTG'], 'resistance': 'high', 'fitness': 'moderate_decrease', 'class': 'INSTI'},
    'Y143R': {'wt': 'Y', 'mut': 'R', 'drugs': ['RAL'], 'resistance': 'high', 'fitness': 'moderate_decrease', 'class': 'INSTI'},
    'R263K': {'wt': 'R', 'mut': 'K', 'drugs': ['DTG'], 'resistance': 'low', 'fitness': 'high_decrease', 'class': 'INSTI'},
    'E92Q': {'wt': 'E', 'mut': 'Q', 'drugs': ['RAL', 'EVG'], 'resistance': 'moderate', 'fitness': 'minimal', 'class': 'INSTI'},
}
...
def main():
    ...
    # Save with summary
    summary = {cls: {'mean': float(np.mean(by_class[cls])), 'std': float(np.std(by_class[cls])), 'n': len(by_class[cls])}
               for cls in by_class}

    with open(output_path, 'w') as f:
        json.dump({'metadata': {'encoder': '3-adic (V5.11.3)'}, 'summary_by_class': summary, 'results': results}, f, indent=2)
    print(f"\nSaved: {output_path}")
